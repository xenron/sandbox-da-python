...
user_45=pd.read_excel(u'D:/tmp/github/my/sandbox-da-python/src/dg/python_use_case/homework/week05/user45.xls',sheetname=0,header=1)
...
用户45属于第三类别，晚上周末空余时间较多，
词频中比较高的是产房，医院，明星名字，香港，女儿等，该用户可能已经成家并有女儿，同时对明星比较感兴趣。
可以推荐儿童和明星类产品
