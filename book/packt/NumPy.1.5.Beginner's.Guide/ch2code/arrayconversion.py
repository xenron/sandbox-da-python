...
print numpy.fromstring('\x00\x00\x00\x00\x00\x00\xf0?\x00\x00\x00\x00\x00\x00\xf0?\x00\x00\x00\x00\x00\x00\x08@\x00\x00\x00\x00\x00\x00\x00@', dtype=complex)
#Out: array([ 1.+1.j,  3.+2.j]

print "In: fromstring('20:42:52',sep=':', dtype=int)"
print numpy.fromstring('20:42:52',sep=':', dtype=int)
#Out: array([20, 42, 52])
